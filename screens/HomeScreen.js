...
export default function HomeScreen(){
  ...
  return (
    <View className="flex-1 bg-neutral-900">
        ...
        <TouchableOpacity className="pb-5" onPress={() => navigator.navigate('Genre')}>
            <Text className="text-white bg-neutral-700 text-xl w-full text-center px-7 py-2 rounded-full font-semibold">List
